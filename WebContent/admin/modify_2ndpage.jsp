...
<div class="container-fluid">
	<div class="row-fluid">
		...
		<div class="col-md-10">
			...
			<form action = "Admin/save2ndPage" method = "post" enctype="multipart/form-data">
		<input type = "hidden" name = "article.id" value='<s:property value = "article.id"/>'/>
		<input type = "hidden" name = "article.category.id" value='<s:property value = "article.category.id"/>'/>
		<input type = "hidden" name = "article.imgUrl" value='<s:property value = "article.imgUrl"/>'/>
		<input type ='submit'/>
		 是否显示在主页墙上: 
		 ...
		 <img src='<s:property value ="article.imgUrl"/>'/>
		<input type='file' name ="upload"/>
		
		 文章类别：<s:property value="article.category.name" />
