...
public class ArticleServiceForArticleTest {
	@Autowired
	...
	public void addInfomationTest(){
		u = us.getUserByUsernameAndPassword(u.getUsername(),u.getPassword());
